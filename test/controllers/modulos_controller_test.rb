...
class ModulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create modulo" do
    assert_difference('Modulo.count') do
      post modulos_url, params: { modulo: { fecha_fin: @modulo.fecha_fin, fecha_inicio: @modulo.fecha_inicio, nombre: @modulo.nombre } }
    end
  ...
  test "should update modulo" do
    patch modulo_url(@modulo), params: { modulo: { fecha_fin: @modulo.fecha_fin, fecha_inicio: @modulo.fecha_inicio, nombre: @modulo.nombre } }
